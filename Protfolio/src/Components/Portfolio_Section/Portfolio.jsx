    ...
    <div className="text-white mt-11 py-5 mx-8 px-10 h-full">
      ...
      <div className="flex gap-5 justify-evenly flex-wrap">
        {cartItems.map(({ id, logo, name,Description,link }) => (
          ...
          <motion.div
            key={id}
            className="flex flex-col items-center gap-2 cart text-black md:w-[330px] border-2 border-black bg-slate-100 rounded-lg p-4 shadow-[0_14px_16px_0_rgba(255,255,255,0.2)] hover:scale-105 duration-500"
            initial={{ scale: 0.2, y: 50 }} // Start small and below the position
            whileInView={{ scale: 1, y: 0 }} // Animate to full size and correct position
            viewport={{ once: false, amount: 0.1 }} // Animate when 20% of the card is visible
            transition={{
          ...
          >
            <img src={logo} className="w-[280px] h-[340px] bg-white border-[2px] border-slate-300" alt={name} />
          ...
          <motion.div
            className="flex flex-col items-center gap-2  mt-10 cart text-black md:w-[38%] border-2 border-black bg-slate-100 rounded-lg p-4 shadow-[0_14px_16px_0_rgba(255,255,255,0.2)] hover:scale-105 duration-500"
            initial={{ scale: 0.2, y: 50 }} // Start small and below the position
            whileInView={{ scale: 1, y: 0 }} // Animate to full size and correct position
            viewport={{ once: false, amount: 0.1 }} // Animate when 20% of the card is visible
            transition={{
            ...
            <img src={Freelancing} className="w-[480px] h-[380px] bg-white border-[2px] border-slate-300"  />
          ...
          <motion.div
            ...
            <img src={Ecommerce} className="w-[480px] h-[380px] bg-white border-[2px] border-slate-300"  />
